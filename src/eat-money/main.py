...
from eatmoney.food import Food
from eatmoney.CalorieNinja import find_food_data
...
class MyApp(App):
    def build(self):
        ...
        #add logo
        self.window.add_widget(Image(source='./src/eatmoney/eatmoneylogo.png'))
    ...
    def remember_preference(self):
        with open('./src/eatmoney/preferences.json', 'r') as r_prefs:
    ...
    def save_preferences(self):
        ...
        with open('./src/eatmoney/preferences.json', 'w') as w_prefs:
    ...
    def read_old_data(self):
        with open("./src/eatmoney/data.csv") as csv_file:
    ...
    def add_new_data(self, data):
        with open('./src/eatmoney/data.csv', 'a', newline='') as f:
            writer = csv.writer(f)
